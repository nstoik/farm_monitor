...
def delete_wifi_network(wifi_id):
    ...
    session.query(Wifi).filter_by(id=wifi_id).delete()
    session.commit()
...
def set_ap_mode():
    """Perform all of the setup and intialization work for interfaces with an AP present."""
...
def set_wpa_mode():
    """Preform all of the setup and intialization work for interfaces with no AP present."""
